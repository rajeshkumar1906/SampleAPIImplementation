...
import com.rajeshkumar.sampleapiimplementation.di.OnlineApi
import com.rajeshkumar.sampleapiimplementation.di.OnlineApiImpl
...
class OnlineMode(val liveData: MutableLiveData<List<Root>>) {
    ...
    init {
//        initData()
//        onlineApi.doNetworkCall(liveData)
    }
